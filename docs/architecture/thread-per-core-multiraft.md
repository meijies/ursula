...
Raft RPCs before client traffic touches those groups, and serves the registered
Raft gRPC routes in the production binary. OpenRaft
...
tests' default 5s wrapper on a MacBook: metrics point to file-log
