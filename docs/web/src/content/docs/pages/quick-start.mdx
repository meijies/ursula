...
It binds `127.0.0.1:4437`, picks a core count from your CPU, and uses the in-memory engine. For local WAL-backed persistence instead, point `--wal-dir` at an empty directory:
