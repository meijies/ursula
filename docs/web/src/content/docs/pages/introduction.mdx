...
description: A self-hosted, distributed server for append-only event timelines. Thread-per-core, multi-Raft, S3-backed.
---
...
- **[ursulactl](/docs/cli):** the operator CLI for a running cluster — rolling restart, status, readiness gate
