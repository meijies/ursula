...
const pageOrder: Record<string, { group: string; order: number; title?: string }> = {
  ...
  "concepts/read-modes": { group: "Concepts", order: 4 },
  "concepts/exactly-once-writes": { group: "Concepts", order: 5 },
  "concepts/conditional-writes": { group: "Concepts", order: 6 },
  "concepts/snapshots": { group: "Concepts", order: 7 },
  "concepts/bootstrap": { group: "Concepts", order: 8 },
  "concepts/durability-and-consistency": { group: "Concepts", order: 9 },
